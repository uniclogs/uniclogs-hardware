...
#define button_cw 0 // A0 // A2 // 0              // normally open button to ground for manual CW rotation (schematic pin: A1)
#define button_ccw 0 // A1 // A3 // 0             // normally open button to ground for manual CCW rotation (schematic pin: A2)
...
#define blink_led 0
#define az_stepper_motor_pulse 0 // 44 //0
...
/*----------- elevation pins --------------*/
  ...
  #define button_up 0 // A2 // A4 // 0               // normally open button to ground for manual up elevation
  #define button_down 0 // A3 // A5 // 0             // normally open button to ground for manual down rotation
